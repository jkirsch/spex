 ...
 */
public class AdaptedCompColMatrix extends AbstractMatrix {
    ...
    public AdaptedCompColMatrix(int numRows, int numColumns, double[] data, int[] columnPointer, int[] rowIndex) {
     ...
     */
    public AdaptedCompColMatrix(MatrixVectorReader r) throws IOException {
     ...
     */
    public AdaptedCompColMatrix(int numRows, int numColumns, int[][] nz) {
        super(numRows, numColumns);
        construct(nz);
    }
    ...
    private void construct(Matrix A, boolean deep) {
        if (deep) {
            if (A instanceof AdaptedCompColMatrix) {
                AdaptedCompColMatrix Ac = (AdaptedCompColMatrix) A;
     ...
     */
    public AdaptedCompColMatrix(Matrix A, boolean deep) {
        super(A);
        construct(A, deep);
    }
     ...
     */
    public AdaptedCompColMatrix(Matrix A) {
        this(A, true);
    }
    ...
    @Override
    public AdaptedCompColMatrix copy() {
        return new AdaptedCompColMatrix(this);
    }
    ...
    @Override
    public AdaptedCompColMatrix zero() {
        Arrays.fill(data, 0);
        return this;
    }
