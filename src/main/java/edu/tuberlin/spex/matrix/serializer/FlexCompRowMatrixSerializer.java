 ...
 */
public class FlexCompRowMatrixSerializer extends Serializer<FlexCompRowMatrix> implements Serializable {
    @Override
    public void write(Kryo kryo, Output output, FlexCompRowMatrix matrix) {
    ...
    @Override
    public FlexCompRowMatrix read(Kryo kryo, Input input, Class<FlexCompRowMatrix> type) {
        int rows = input.readInt();
        int columns = input.readInt();
        int size = input.readInt();

        FlexCompRowMatrix matrix = new FlexCompRowMatrix(rows, columns);
